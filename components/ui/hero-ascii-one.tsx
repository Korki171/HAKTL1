      ...
      <div className="absolute top-0 left-0 right-0 z-20 border-b border-white/20">
        <div className="container mx-auto px-4 lg:px-8 py-3 lg:py-4 flex items-center justify-between">
          <div className="flex items-center gap-2 lg:gap-4">
            <div className="font-sans text-xl lg:text-2xl font-extrabold tracking-[0.35em] uppercase">
              <span className="text-red-500">H</span>
              <span className="text-blue-500">A</span>
              <span className="text-red-500">K</span>
              <span className="text-blue-500">TL</span>
            </div>
            <div className="h-3 lg:h-4 w-px bg-slate-300/70"></div>
            <span className="text-slate-500 text-[8px] lg:text-[10px] font-sans uppercase">EST. 2025</span>
          </div>
        ...
        <div className="w-full lg:w-1/2 px-6 lg:px-16 lg:pr-[10%]">
          <div className="max-w-lg relative lg:ml-auto">
            <div className="flex items-center gap-2 mb-3 opacity-70">
              ...
              <span className="text-slate-500 text-[10px] font-mono tracking-wider">∞</span>
              <div className="flex-1 h-px bg-slate-300"></div>
            </div>
            <div className="relative">
              <div className="hidden lg:block absolute -right-3 top-0 bottom-0 w-1 dither-pattern opacity-40"></div>
              <h1 className="text-3xl lg:text-5xl font-extrabold mb-3 lg:mb-4 leading-tight font-sans tracking-tight whitespace-nowrap lg:-ml-[5%] text-transparent bg-clip-text bg-gradient-to-r from-sky-200 via-slate-100 to-white" style={{ letterSpacing: '0.08em' }}>
                HAKTL<br />DEINE PREMIUM<br />LERNPLATTFORM
              </h1>
            </div>
            ...
            <div className="relative">
              <p className="text-sm lg:text-base text-slate-200 mb-5 lg:mb-6 leading-relaxed font-sans opacity-90">
                HAKTL macht aus Schulstress klare Fortschritte — lerne fokussiert, bleib motiviert und meistere jede Prüfung mit mehr Selbstvertrauen.
              </p>
            ...
            <div className="flex flex-col lg:flex-row gap-3 lg:gap-4">
              <button className="relative px-5 lg:px-6 py-2 lg:py-2.5 bg-sky-500/15 text-sky-100 font-sans text-xs lg:text-sm border border-sky-300/40 hover:bg-sky-400/15 hover:text-white transition-all duration-200 group">
              ...
              <button className="relative px-5 lg:px-6 py-2 lg:py-2.5 bg-white/5 border border-sky-300/30 text-sky-100 font-sans text-xs lg:text-sm hover:bg-sky-400/15 hover:text-white transition-all duration-200" style={{ borderWidth: '1px' }}>
                EMBRACE THE JOURNEY
              </button>
            </div>
